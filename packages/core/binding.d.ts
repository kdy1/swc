...
export class EstreeExpressionStatement {}

export class EstreeProgram {
    asScript(): EstreeScript | null;
}

export class EstreeScript {
    getBody(): EstreeStatements;
}

export class EstreeStatement {
    asExpressionStatement(): EstreeExpressionStatement | null;
}

export class EstreeStatements {
    get length(): number;
    get(index: number): EstreeStatement;
}
